...
public class ClsNliodCls extends QanaryComponent {
	...
	public QanaryMessage process(QanaryMessage myQanaryMessage) throws Exception {
        ...
        try {
			File f = new File("qanary_component-CLS-CLSNLIOD/src/main/resources/questions_CLS-CLSNLIOD.txt");
			f.createNewFile();
...
BufferedWriter buffWriter = new BufferedWriter(new FileWriter("qanary_component-CLS-CLSNLIOD/src/main/resources/questions_CLS-CLSNLIOD.txt", true));
