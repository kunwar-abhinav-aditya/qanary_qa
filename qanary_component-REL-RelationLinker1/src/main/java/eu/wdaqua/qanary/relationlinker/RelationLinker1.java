	...
	public QanaryMessage process(QanaryMessage myQanaryMessage) throws Exception {
		...
		QanaryUtils myQanaryUtils = this.getUtils(myQanaryMessage);
	      ...
	      ArrayList<Link> links = new ArrayList<Link>();
		    ...
		    try {
				File f = new File("qanary_component-REL-RelationLinker1/src/main/resources/questions_REL-RelationLinker1.txt");
				f.createNewFile(); 
...
//	        }
	        ...
	        BufferedWriter buffWriter = new BufferedWriter(new FileWriter("qanary_component-REL-RelationLinker1/src/main/resources/questions_REL-RelationLinker1.txt", true));
	        Gson gson = new Gson();
