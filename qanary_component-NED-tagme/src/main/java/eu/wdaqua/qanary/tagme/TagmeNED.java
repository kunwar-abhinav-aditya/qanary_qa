...
public class TagmeNED extends QanaryComponent {
	...
	public QanaryMessage process(QanaryMessage myQanaryMessage) throws Exception {
	    ...
	    try {
			File f = new File("qanary_component-NED-tagme/src/main/resources/questions_NED-tagme.txt");
			f.createNewFile(); 
...
//			Iterator<?> keys = jsonObject.keys();
	    ...
	    try {
	        ...
	        BufferedWriter buffWriter = new BufferedWriter(new FileWriter("qanary_component-NED-tagme/src/main/resources/questions_NED-tagme.txt", true));
	        Gson gson = new Gson();
