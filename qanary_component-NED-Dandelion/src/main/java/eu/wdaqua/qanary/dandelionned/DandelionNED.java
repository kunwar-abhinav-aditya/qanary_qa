...
public class DandelionNED extends QanaryComponent {
	...
	public QanaryMessage process(QanaryMessage myQanaryMessage) throws Exception {
	    ...
	    try {
	    	File f = new File("qanary_component-NED-Dandelion/src/main/resources/questions_NED-Dandelion.txt");
	    	f.createNewFile(); 
...
//			Iterator<?> keys = jsonObject.keys();
	   ...
	   // HttpGet httpget = new HttpGet("https://api.dandelion.eu/datatxt/nex/v1/?text="+thePath+"&include=types%2Cabstract%2Ccategories&token=0990bd650d9545709da047537ff05a49");
	    ...
	    try {
	        ...
	        BufferedWriter buffWriter = new BufferedWriter(new FileWriter("qanary_component-NED-Dandelion/src/main/resources/questions_NED-Dandelion.txt", true));
	        Gson gson = new Gson();
