package eu.wdaqua.qanary.diambiguationclass;
		...
		for (String vars : allClassses.keySet()) {
			...
			for (String urls : allUrls.keySet()) {
				...
				sparql = "prefix qa: <http://www.wdaqua.eu/qa#> "
						...
						+ "prefix xsd: <http://www.w3.org/2001/XMLSchema#> " + "INSERT { " + "GRAPH <" + namedGraph+ "> { " + " ?a a qa:AnnotationOfClass . " + " ?a oa:hasTarget [ " + " a oa:SpecificResource; "
