...
public class AmbiverseNed extends QanaryComponent {
	...
	public QanaryMessage process(QanaryMessage myQanaryMessage) throws Exception{
	   ...
	   /* try {
			File f = new File("qanary_component-NED-Ambiverse/src/main/resources/questions_NED-Ambiverse.txt");
			f.createNewFile(); 
...
//			Iterator<?> keys = jsonObject.keys();
		...
		logger.info("accessTokenCmd {}", Arrays.toString(accessTokenCmd));
		try {
			...
			if(access_token != null){
				...
				String[] entityLinkCmd = {"curl", "--request", "POST", "--header", "Content-Type: application/json", 
						...
						"Authorization: Bearer: "+access_token,  "-d", jsonThePath, "--url", urlEntityLinkService };
				...
				System.out.println("EntityLinkInfoArray1: " + jsonArrayEL1.toString());
		...
		//	 BufferedWriter buffWriter = new BufferedWriter(new FileWriter("qanary_component-NED-Ambiverse/src/main/resources/questions_NED-Ambiverse.txt", true));
		  //      Gson gson = new Gson();
