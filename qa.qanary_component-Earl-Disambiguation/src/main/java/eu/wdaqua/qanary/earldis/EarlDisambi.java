package eu.wdaqua.qanary.earldis;
 ...
 */
public class EarlDisambi extends QanaryComponent {
	private static final Logger logger = LoggerFactory.getLogger(EarlDisambi.class);
	...
	public QanaryMessage process(QanaryMessage myQanaryMessage) throws Exception{
		...
		for (Selection s : selections) {
            String sparql = "PREFIX qa: <http://www.wdaqua.eu/qa#> " //
                    ...
                    + "  ] . " //
                    + "  ?a oa:hasBody <" + s.link + "> ;" //
                    + "     oa:annotatedBy <http://earlentitydisambiguator.com> ; " //
                    + "	    oa:AnnotatedAt ?time  " + "}} " //
                    + "WHERE { " //
