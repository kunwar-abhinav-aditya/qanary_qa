package eu.wdaqua.qanary.earlentity;
 ...
 */
public class EarlEntityIdf extends QanaryComponent {
	private static final Logger logger = LoggerFactory.getLogger(EarlEntityIdf.class);
	...
	public QanaryMessage process(QanaryMessage myQanaryMessage) throws Exception{
		...
		for (Selection s : selections) {
            String sparql = "PREFIX qa: <http://www.wdaqua.eu/qa#> " //
                    ...
                    + "           ] " //
                    + "  ] ; " //
                    + "     oa:annotatedBy <http://earlentityrecogniser.com> ; " //
                    + "	    oa:AnnotatedAt ?time  " + "}} " //
                    + "WHERE { " //
