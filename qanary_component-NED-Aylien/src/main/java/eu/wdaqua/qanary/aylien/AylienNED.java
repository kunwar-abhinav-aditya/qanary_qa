...
public class AylienNED extends QanaryComponent {
	...
	public QanaryMessage process(QanaryMessage myQanaryMessage) throws Exception {
	    ...
	    try {
			File f = new File("qanary_component-NED-Aylien/src/main/resources/questions_NED-Aylien.txt");
			f.createNewFile(); 
...
//			Iterator<?> keys = jsonObject.keys();
	    ...
	    try {    	 
	        ...
	        BufferedWriter buffWriter = new BufferedWriter(new FileWriter("qanary_component-NED-Aylien/src/main/resources/questions_NED-Aylien.txt", true));
	        Gson gson = new Gson();
