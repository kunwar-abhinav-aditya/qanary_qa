...
public class OntoTextNED extends QanaryComponent {
	...
	public QanaryMessage process(QanaryMessage myQanaryMessage) throws Exception {
		...
		QanaryUtils myQanaryUtils = this.getUtils(myQanaryMessage);
	      ...
	      try {
				File f = new File("qanary_component-NED-Ontotext/src/main/resources/questions_NED-Ontotext.txt");
				f.createNewFile(); 
...
//	        }
	        ...
	        BufferedWriter buffWriter = new BufferedWriter(new FileWriter("qanary_component-NED-Ontotext/src/main/resources/questions_NED-Ontotext.txt", true));
	        Gson gson = new Gson();
