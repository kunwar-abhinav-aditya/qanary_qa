...
public class BabelfyNED extends QanaryComponent {
	...
	public QanaryMessage process(QanaryMessage myQanaryMessage) throws Exception {
	    ...
	    try {
			File f = new File("qanary_component-NED-Babelfy/src/main/resources/questions_NED-Babelfy.txt");
			f.createNewFile(); 
			f.createNewFile(); 
...
//			Iterator<?> keys = jsonObject.keys();
	    ...
	    if(questionCount < 980) {
	    		httpget = new HttpGet("https://babelfy.io/v1/disambiguate?text="+thePath+"&lang=AGNOSTIC&key=ce8b60dd-0dbf-4983-ae63-c275b3b8378e");
	    }
	     	...
	     	httpget = new HttpGet("https://babelfy.io/v1/disambiguate?text="+thePath+"&lang=AGNOSTIC&key=57d661bf-61fc-4798-ad15-1c8af09edff4");
    			...
    			httpget = new HttpGet("https://babelfy.io/v1/disambiguate?text="+thePath+"&lang=AGNOSTIC&key=54c2f995-0b2a-4f46-beb0-002202765241");
	    }
	    ...
	    try {
	        ...
	        BufferedWriter buffWriter = new BufferedWriter(new FileWriter("qanary_component-NED-Babelfy/src/main/resources/questions_NED-Babelfy.txt", true));
	        Gson gson = new Gson();
		...
		for (Link l : links) {
            String sparql = "PREFIX qa: <http://www.wdaqua.eu/qa#> " //
                    ...
                    + "  ] . " //
                    + "  ?a oa:hasBody <" + l.link + "> ;" //
                    + "     oa:annotatedBy <https:babelfyNED.com> ; " //
                    + "	    oa:AnnotatedAt ?time  " + "}} " //
                    + "WHERE { " //
